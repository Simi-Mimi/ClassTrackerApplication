...
## הצעות לשיפור
יש דרישה שהגישה ל-API תהיה חשופה למורים בלבד, ולכן הורים שיבקשו לדעת היכן ילדיהם- ישלח להם המורה את נתוני הילד שלהם ביחס למיקום המורה.
עשיתי מחיקת מיקומים ישנים, אבל עדיף לשמור את הנתונים עבור הוספת פיצ'רים עתידי (כגון סימון מסלול וכו')
הוספתי טבלה ב-DB עבור מכשיר האיכון עצמו, וכן קישרתי אותו לישויות המתאימות עבור שימוש עתידי 
